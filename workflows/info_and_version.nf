include { IMAGES; TOOLS; COMBINE_INFO; PARSE; PRINT; SAVE; ARIBA_VERSION; PYTHON_VERSION; CLINKER_VERSION; BWA_VERSION; BCFTOOLS_VERSION; SAMTOOLS_VERSION; BLAST_VERSION; BEDTOOLS_VERSION; BAKTA_VERSION; UNICYCLER_VERSION; SEROBA_VERSION; PANAROO_VERSION; SNP_DISTS_VERSION } from "$projectDir/modules/info"
